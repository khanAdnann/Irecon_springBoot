...
@Getter
@Setter
@Table(name = "rupay_qsparc_network_adjustment")
public class QsparcDomesticAdjustmentRawData {
    ...
    @Column(length = 100)
    private String lastAdjStage;

    @Column(length = 100)
    private String lastAdjDate;
	...
	public String getLastAdjStage() {
		return lastAdjStage;
	}

	public void setLastAdjStage(String lastAdjStage) {
		this.lastAdjStage = lastAdjStage;
	}

	public String getLastAdjDate() {
		return lastAdjDate;
	}

	public void setLastAdjDate(String lastAdjDate) {
