...
@Repository
public interface QsparcDomesticOfflinePrasentmentRawDataRepository extends JpaRepository<QsparcDomesticOfflinePresentmentRawData, Long>{

	List<QsparcDomesticOfflinePresentmentRawData> findByFilenameAndFileDate(String filename, String fileDate);
}
