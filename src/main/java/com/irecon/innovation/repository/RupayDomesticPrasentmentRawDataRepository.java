...
@Repository
public interface RupayDomesticPrasentmentRawDataRepository extends JpaRepository<RupayDomesticPresentmentRawData, Long>{

	List<RupayDomesticPresentmentRawData> findByFilenameAndFileDate(String filename, String fileDate);
}
