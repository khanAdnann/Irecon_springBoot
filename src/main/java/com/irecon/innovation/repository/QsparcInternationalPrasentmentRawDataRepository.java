...
@Repository
public interface QsparcInternationalPrasentmentRawDataRepository extends JpaRepository<QsparcInternationalPresentmentRawData, Long>{

	List<QsparcInternationalPresentmentRawData> findByFilenameAndFileDate(String filename, String fileDate);
}
