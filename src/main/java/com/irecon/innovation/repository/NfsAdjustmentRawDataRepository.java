...
@Repository
public interface NfsAdjustmentRawDataRepository extends JpaRepository<NfsAdjustmentRawData, Long> {
	List<NfsAdjustmentRawData> findByFileNameAndFileDate(String fileName, String fileDate);
}