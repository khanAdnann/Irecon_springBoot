...
import com.irecon.innovation.entity.QsparcDomesticAdjustmentRawData;
...
import com.irecon.innovation.repository.QsparcDomesticAdjustmmentRawDataRepository;
...
@Service
public class QsparcDomesticAdjustmentRawDataServiceImpl implements QsparcDomesticAdjustmentRawDataService{

	private static final Logger logger = LoggerFactory.getLogger(QsparcDomesticAdjustmentRawDataServiceImpl.class);

	@Autowired
	private QsparcDomesticAdjustmmentRawDataRepository qsparcAdjustmmentRawDataRepository;

	@Autowired
	private CommonDataValidationRepository commonDataValidationRepository;

	@Override
	public boolean SaveQsparcDomesticAdjustmentRawData(MultipartFile file, String fileDate,String Cycle) {
		logger.info("Save method SaveNfsIssRawData " + fileDate);



		 List<QsparcDomesticAdjustmentRawData> batchList = new ArrayList<>();
		    int batchSize = 1000;
		    int Count = 0;
		    ...
		    try (CSVReader reader = new CSVReader(new InputStreamReader(file.getInputStream()))) {
		        ...
		        while ((fields = reader.readNext()) != null) {
		            ...
		            // Map to Entity
		            QsparcDomesticAdjustmentRawData entity = new QsparcDomesticAdjustmentRawData();
		            int i = 0;
		        ...
		        int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC DOM ADJUSTMENT CYCLE "+ Cycle, fileDate, file.getOriginalFilename(), String.valueOf(Count), "Y");
