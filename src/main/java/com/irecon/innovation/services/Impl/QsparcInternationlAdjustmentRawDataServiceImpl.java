...
import com.irecon.innovation.entity.QsparcInternationalAdjustmentRawData;
...
import com.irecon.innovation.repository.QsparcInternationalAdjustmmentRawDataRepository;
...
@Service
public class QsparcInternationlAdjustmentRawDataServiceImpl implements QsparcInternationalAdjustmentRawDataService {

	private static final Logger logger = LoggerFactory.getLogger(QsparcInternationlAdjustmentRawDataServiceImpl.class);

	@Autowired
	private QsparcInternationalAdjustmmentRawDataRepository qsparcAdjustmmentRawDataRepository;

	@Autowired
	private CommonDataValidationRepository commonDataValidationRepository;

	@Override
	public boolean SaveQsparcInternationalAdjustmentRawData(MultipartFile file, String fileDate, String cycle) {
		logger.info("Save method SaveQsparcInternationalAdjustmentRawData " + fileDate);



		 List<QsparcInternationalAdjustmentRawData> batchList = new ArrayList<>();
		    int batchSize = 1000;
		    int Count = 0;
		    ...
		    try (CSVReader reader = new CSVReader(new InputStreamReader(file.getInputStream()))) {
		        ...
		        while ((fields = reader.readNext()) != null) {
		            ...
		            // Map to Entity
		            QsparcInternationalAdjustmentRawData entity = new QsparcInternationalAdjustmentRawData();
		            int i = 0;
		            ...
		            if (batchList.size() == batchSize) {
		            	qsparcAdjustmmentRawDataRepository.saveAll(batchList);
		                batchList.clear();
		            }
		        }
	            ...
	            int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC INT ADJUSTMENT CYCLE 1", fileDate, file.getOriginalFilename(), String.valueOf(Count), "Y");
