...
import com.irecon.innovation.repository.Rupay01DomesticRawDataRepository;
import com.irecon.innovation.repository.Rupay02DomesticRawDataRepository;
import com.irecon.innovation.repository.Rupay03DomesticRawDataRepository;
import com.irecon.innovation.repository.Rupay05DomesticRawDataRepository;
import com.irecon.innovation.repository.Rupay86DomesticRawDataRepository;
import com.irecon.innovation.repository.Rupay88DomesticRawDataRepository;
...
@Service
public class RupayDomesticRawDataServiceImpl implements RupayDomesticRawDataService {

	private static final Logger logger = LoggerFactory.getLogger(RupayDomesticRawDataServiceImpl.class);

	@Autowired
	private Rupay88DomesticRawDataRepository rupay88DomesticRawDataRepository;
	@Autowired
	private Rupay01DomesticRawDataRepository rupay01DomesticRawDataRepository;
	@Autowired
	private Rupay02DomesticRawDataRepository rupay02DomesticRawDataRepository;
	@Autowired
	private Rupay03DomesticRawDataRepository rupay03DomesticRawDataRepository;
	@Autowired
	private Rupay05DomesticRawDataRepository rupay05DomesticRawDataRepository;

	@Autowired
	private Rupay86DomesticRawDataRepository rupay86DomesticRawDataRepository;
	...
	public boolean SaveRupayDomesticRawData(MultipartFile file, String fileDate) {
		logger.info("Save method SaveRupayDomesticRawData " + fileDate);
		...
		try {
			...
			if (file.getOriginalFilename().substring(0, 2).equalsIgnoreCase("88")) {
				...
				Set<Rupay88DomesticRawData> rawDataSet = new HashSet<>();
				...
				while ((thisLine = reader.readLine()) != null) {
					...
					if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
						...
						if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
							...
							Rupay88DomesticRawData entity = new Rupay88DomesticRawData();
							...
							if (++batchCount % batchSize == 0) {
								...
								rupay88DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Rupay88DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 88 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
				...
				Set<Rupay01DomesticRawData> rawDataSet = new HashSet<>();
				Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
				Pattern node_REGEX = Pattern.compile("<(.+?)>");
				RupayHeaderUtil headerUtil = new RupayHeaderUtil();
				RupayUtilBean utilBean = new RupayUtilBean();
				...
				while ((thisLine = reader.readLine()) != null) {
					...
					if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
						...
						if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
							...
							Rupay01DomesticRawData entity = new Rupay01DomesticRawData();
							...
							if (++batchCount % batchSize == 0) {
								...
								logger.info("Batch Executed is " + batchNumber);
								rupay01DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Rupay01DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 01 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
					logger.error("Upload Status updated");
				}else {
				...
				Set<Rupay02DomesticRawData> rawDataSet = new HashSet<>();
				Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
				Pattern node_REGEX = Pattern.compile("<(.+?)>");
				RupayHeaderUtil headerUtil = new RupayHeaderUtil();
				RupayUtilBean utilBean = new RupayUtilBean();
				...
				while ((thisLine = reader.readLine()) != null) {
					...
					if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
						...
						if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
							...
							Rupay02DomesticRawData entity = new Rupay02DomesticRawData();
							...
							if (++batchCount % batchSize == 0) {
								...
								logger.info("Batch Executed is " + batchNumber);
								rupay02DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Rupay02DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 02 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
					logger.error("Upload Status updated");
				}else {
				...
				Set<Rupay03DomesticRawData> rawDataSet = new HashSet<>();
				Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
				Pattern node_REGEX = Pattern.compile("<(.+?)>");
				RupayHeaderUtil headerUtil = new RupayHeaderUtil();
				RupayUtilBean utilBean = new RupayUtilBean();
				...
				while ((thisLine = reader.readLine()) != null) {
					...
					if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
						...
						if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
							...
							Rupay03DomesticRawData entity = new Rupay03DomesticRawData();
							...
							if (++batchCount % batchSize == 0) {
								...
								logger.info("Batch Executed is " + batchNumber);
								rupay03DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Rupay03DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 03 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
					logger.error("Upload Status updated");
				}else {
				...
				Set<Rupay05DomesticRawData> rawDataSet = new HashSet<>();
				Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
				Pattern node_REGEX = Pattern.compile("<(.+?)>");
				RupayHeaderUtil headerUtil = new RupayHeaderUtil();
				RupayUtilBean utilBean = new RupayUtilBean();
				...
				while ((thisLine = reader.readLine()) != null) {
					...
					if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
						...
						if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
							...
							Rupay05DomesticRawData entity = new Rupay05DomesticRawData();
							...
							if (++batchCount % batchSize == 0) {
								...
								logger.info("Batch Executed is " + batchNumber);
								rupay05DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Rupay05DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 05 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
					logger.error("Upload Status updated");
				}else {
				...
				Set<Rupay86DomesticRawData> rawDataSet = new HashSet<>();
				Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
				Pattern node_REGEX = Pattern.compile("<(.+?)>");
				RupayHeaderUtil headerUtil = new RupayHeaderUtil();
				RupayUtilBean utilBean = new RupayUtilBean();
				...
				logger.info("Process started " + (new Date()).getTime());
				while ((thisLine = reader.readLine()) != null) {
					Rupay86DomesticRawData entity = new Rupay86DomesticRawData();
					...
					if (thisLine.startsWith("01")) {
						...
						if (++batchCount % batchSize == 0) {
							...
							logger.info("Batch Executed is " + batchNumber);
							rupay86DomesticRawDataRepository.saveAll(rawDataSet);
							rawDataSet = new HashSet<Rupay86DomesticRawData>();
				...
				int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("RUPAY 86 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
				if(updateStatus>0) {
					logger.error("Upload Status updated");
				}else {
