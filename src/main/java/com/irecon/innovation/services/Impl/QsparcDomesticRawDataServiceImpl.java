...
import com.irecon.innovation.repository.Qsparc01DomesticRawDataRepository;
import com.irecon.innovation.repository.Qsparc02DomesticRawDataRepository;
import com.irecon.innovation.repository.Qsparc03DomesticRawDataRepository;
import com.irecon.innovation.repository.Qsparc05DomesticRawDataRepository;
import com.irecon.innovation.repository.Qsparc86DomesticRawDataRepository;
import com.irecon.innovation.repository.Qsparc88DomesticRawDataRepository;
...
@Service
public class QsparcDomesticRawDataServiceImpl implements QsparcDomesticRawDataService {

	private static final Logger logger = LoggerFactory.getLogger(QsparcDomesticRawDataServiceImpl.class);

	@Autowired
	private Qsparc88DomesticRawDataRepository qsparc88DomesticRawDataRepository;

	
	@Autowired
	private Qsparc01DomesticRawDataRepository qsparc01DomesticRawDataRepository;
	@Autowired
	private Qsparc02DomesticRawDataRepository qsparc02DomesticRawDataRepository;
	@Autowired
	private Qsparc03DomesticRawDataRepository qsparc03DomesticRawDataRepository;
	@Autowired
	private Qsparc05DomesticRawDataRepository qsparc05DomesticRawDataRepository;


	@Autowired
	private Qsparc86DomesticRawDataRepository qsparc86DomesticRawDataRepository;
	...
	public boolean SaveQsparcDomesticRawData(MultipartFile file, String fileDate) {
		...
		logger.info("Save method SaveQsparcDomesticRawData " + fileDate);
		...
		try {
				...
				if (file.getOriginalFilename().substring(0, 2).equalsIgnoreCase("88")) {
					...
					Set<Qsparc88DomesticRawData> rawDataSet = new HashSet<>();
					...
					while ((thisLine = reader.readLine()) != null) {
						...
						if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
							...
							if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
								...
								Qsparc88DomesticRawData entity = new Qsparc88DomesticRawData();
								...
								if (++batchCount % batchSize == 0) {
									...
									qsparc88DomesticRawDataRepository.saveAll(rawDataSet);
									rawDataSet = new HashSet<Qsparc88DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 88 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
					...
					Set<Qsparc01DomesticRawData> rawDataSet = new HashSet<>();
					Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
					Pattern node_REGEX = Pattern.compile("<(.+?)>");
					QsparcHeaderUtil headerUtil = new QsparcHeaderUtil();
					QsparcUtilBean utilBean = new QsparcUtilBean();
					...
					while ((thisLine = reader.readLine()) != null) {
						...
						if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
							...
							if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
								...
								Qsparc01DomesticRawData entity = new Qsparc01DomesticRawData();
								...
								if (++batchCount % batchSize == 0) {
									...
									logger.info("Batch Executed is " + batchNumber);
									qsparc01DomesticRawDataRepository.saveAll(rawDataSet);
									rawDataSet = new HashSet<Qsparc01DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 01 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
						logger.error("Upload Status updated");
					}else {
					...
					Set<Qsparc02DomesticRawData> rawDataSet = new HashSet<>();
					Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
					Pattern node_REGEX = Pattern.compile("<(.+?)>");
					QsparcHeaderUtil headerUtil = new QsparcHeaderUtil();
					QsparcUtilBean utilBean = new QsparcUtilBean();
					...
					while ((thisLine = reader.readLine()) != null) {
						...
						if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
							...
							if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
								...
								Qsparc02DomesticRawData entity = new Qsparc02DomesticRawData();
								...
								if (++batchCount % batchSize == 0) {
									...
									logger.info("Batch Executed is " + batchNumber);
									qsparc02DomesticRawDataRepository.saveAll(rawDataSet);
									rawDataSet = new HashSet<Qsparc02DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 02 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
						logger.error("Upload Status updated");
					}else {
					...
					Set<Qsparc03DomesticRawData> rawDataSet = new HashSet<>();
					Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
					Pattern node_REGEX = Pattern.compile("<(.+?)>");
					QsparcHeaderUtil headerUtil = new QsparcHeaderUtil();
					QsparcUtilBean utilBean = new QsparcUtilBean();
					...
					while ((thisLine = reader.readLine()) != null) {
						...
						if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
							...
							if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
								...
								Qsparc03DomesticRawData entity = new Qsparc03DomesticRawData();
								...
								if (++batchCount % batchSize == 0) {
									...
									logger.info("Batch Executed is " + batchNumber);
									qsparc03DomesticRawDataRepository.saveAll(rawDataSet);
									rawDataSet = new HashSet<Qsparc03DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 03 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
						logger.error("Upload Status updated");
					}else {
					...
					Set<Qsparc05DomesticRawData> rawDataSet = new HashSet<>();
					Pattern TAG_REGEX = Pattern.compile(">(.+?)</");
					Pattern node_REGEX = Pattern.compile("<(.+?)>");
					QsparcHeaderUtil headerUtil = new QsparcHeaderUtil();
					QsparcUtilBean utilBean = new QsparcUtilBean();
					...
					while ((thisLine = reader.readLine()) != null) {
						...
						if (!nodeMatcher.group(1).equalsIgnoreCase("Txn")) {
							...
							if (nodeMatcher.group(1).equalsIgnoreCase("/Txn")) {
								...
								Qsparc05DomesticRawData entity = new Qsparc05DomesticRawData();
								...
								if (++batchCount % batchSize == 0) {
									...
									logger.info("Batch Executed is " + batchNumber);
									qsparc05DomesticRawDataRepository.saveAll(rawDataSet);
									rawDataSet = new HashSet<Qsparc05DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 05 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
						logger.error("Upload Status updated");
					}else {
					...
					Set<Qsparc86DomesticRawData> rawDataSet = new HashSet<>();
					...
					logger.info("Process started " + (new Date()).getTime());
					while ((thisLine = reader.readLine()) != null) {
						Qsparc86DomesticRawData entity = new Qsparc86DomesticRawData();
						...
						if (thisLine.startsWith("01")) {
							...
							if (++batchCount % batchSize == 0) {
								...
								logger.info("Batch Executed is " + batchNumber);
								qsparc86DomesticRawDataRepository.saveAll(rawDataSet);
								rawDataSet = new HashSet<Qsparc86DomesticRawData>();
					...
					int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("QSPARC 86 DOM", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
					if(updateStatus>0) {
						logger.error("Upload Status updated");
					}else {
