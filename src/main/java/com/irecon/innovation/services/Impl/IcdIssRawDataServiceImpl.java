...
@Service
public class IcdIssRawDataServiceImpl implements IcdIssRawDataService{

	 private static final Logger logger = LoggerFactory.getLogger(IcdIssRawDataServiceImpl.class);
	 
	 @Autowired
	 private IcdIssRawDataRepository icdIssRawDataRepository;
	 ...
	 @Override
	    public boolean SaveIcdIssRawData(MultipartFile file, String fileDate) {
	        ...
	        Set<IcdIssRawData> rawDataSet = new HashSet<>();
	        ...
	        try {
	            ...
	            while ((thisLine = reader.readLine()) != null) {
	            	DataCount++;
	                IcdIssRawData data = new IcdIssRawData();
	            ...
	            icdIssRawDataRepository.saveAll(rawDataSet);
	            
	            
	            int updateStatus = commonDataValidationRepository.updateStatusByFileTypeOrFiledate("ICD ISSUER", fileDate, file.getOriginalFilename(), String.valueOf(DataCount), "Y");
